...
bond_or_inv = input("Enter either investment or bond from the menu above to proceed: ").lower()     # Input becomes lowercase
...
if bond_or_inv == "investment": 
    ...
    simple_or_compound = input("Please enter if you would like simple or compound interest: ").lower()     # Input becomes lowercase
